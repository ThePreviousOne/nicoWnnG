...
public class SetupKeyboardNico extends SetupKeyboard {
	...
	public int SetupModeKeyString() {
		return R.string.key_12key_mode_nico;
	}
	/*********************************
	 *
	 */
	...
	private static final String[][][][] JP_FULL_NICO_CYCLE_TABLE = {
		{
			{
				{"\u3042"}, {"\u3044"}, {"\u3046"}, {"\u3048"}, {"\u304a"},      {"."},      {"-"},      {"@"},      {"_"}, {"1"},
				{"\u304b"}, {"\u304d"}, {"\u304f"}, {"\u3051"}, {"\u3053"},      {" "},      {"a"},      {"b"},      {"c"}, {"2"},
	...
	private static final HashMap<String, String> JP_FULL_NICO_REPLACE_TABLE_1 = new HashMap<String, String>() {
		/**
		 *
		 */
	...
	private static final HashMap<String, String> JP_FULL_NICO_REPLACE_TABLE_2 = new HashMap<String, String>() {
		/**
		 *
		 */
		private static final long serialVersionUID = 1L;
