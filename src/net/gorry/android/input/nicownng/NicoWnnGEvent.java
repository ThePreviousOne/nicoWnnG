...
public class NicoWnnGEvent {
     ...
     * Convert.
     * <br>
     * This event makes {@link NicoWnnG} to display conversion candidates from {@link ComposingText}.
     */
     ...
     * Predict.
     * <br>
     * This event makes {@link NicoWnnG} to display prediction candidates from {@link ComposingText}.
     */
     ...
     * <br>
     * This event processes a {@code keyEvent}.
     * If the event is not processed in {@link NicoWnnG}, the event is thrown to the IME's client.
     */
     ...
     * Reset status.
     */
    public static final int RESET_STATUS = 0xF0000021;
     ...
     * This event makes {@link NicoWnnG} to display conversion candidates from {@link ComposingText}.
     */
    public static final int CONVERT_PREDICT = 0xF0000022;
    public static final int CONVERT_PREDICT_BACKWARD = 0xF0000023;

    /**
     * Add word to the user dictionary.
     */
    public static final int ADD_WORDS     = 0xF0000024;
    ...
    /**
     * Generate {@link NicoWnnGEvent}
     *
     * @param code      The code
     */
    public NicoWnnGEvent(int code) {
        this.code = code;
    }
    /**
     * Generate {@link NicoWnnGEvent} for changing the mode
     *
     * @param code      The code
     * @param mode      The mode
     */
    public NicoWnnGEvent(int code, int mode) {
        this.code = code;       
        this.mode = mode;
        this.mode2 = 0;
    }
     ...
     * @param code      The code
     * @param mode      The mode
     * @param mode2     The mode2
     */
    public NicoWnnGEvent(int code, int mode, int mode2) {
        this.code = code;       
        this.mode = mode;
        this.mode2 = mode2;
    }
    /**
     * Generate {@link NicoWnnGEvent} for a inputing character
     *
     * @param code      The code
     * @param c         The inputing character
     */
    public NicoWnnGEvent(int code, char c) {
        this.code = code;       
        this.chars = new char[1];
        this.chars[0] = c;
     }
    /**
     * Generate {@link NicoWnnGEvent} for inputing characters
     *
     * @param code      The code
    ...
    /**
     * Generate {@link NicoWnnGEvent} for toggle inputing a character
     *
     * @param code          The code
     * @param toggleTable   The array of toggle inputing a character
     */
    public NicoWnnGEvent(int code, String[] toggleTable) {
        this.code = code;
        this.toggleTable = toggleTable;
    }
    /**
     * Generate {@link NicoWnnGEvent} for replacing a character
     *
     * @param code          The code
     * @param replaceTable  The replace table
     */
    public NicoWnnGEvent(int code, HashMap<?,?> replaceTable) {
        this.code = code;
     ...
     */
    public NicoWnnGEvent(KeyEvent ev) {
     ...
     */
    public NicoWnnGEvent(int code, WnnWord word) {
        this.code = code;       
        this.word = word;
    }

    /**
     * Generate {@link NicoWnnGEvent} for dictionary management
     *
     * @param code      The code
     * @param dict      The type of dictionary
     * @param word      The selected candidate
     */
    public NicoWnnGEvent(int code, int dict, WnnWord word) {
        this.code = code;
     ...
     * @param code      The code
     * @param dict      The type of dictionary
     * @param words     The selected candidate
     * @param progress 
     */
    public NicoWnnGEvent(int code, int dict, WnnWord[] words, Runnable progress) {
        this.code = code;
        this.dictionaryType = dict;
        this.words = words;
