...
/**
 * The interface of dictionary searcher used by {@link NicoWnnG}.
 *
...
public interface WnnDictionary {
     ...
     * @see net.gorry.android.input.nicownng.WnnDictionary#APPROX_PATTERN_EN_TOUPPER
     * @see net.gorry.android.input.nicownng.WnnDictionary#APPROX_PATTERN_EN_TOLOWER
     * @see net.gorry.android.input.nicownng.WnnDictionary#APPROX_PATTERN_EN_QWERTY_NEAR
     * @see net.gorry.android.input.nicownng.WnnDictionary#APPROX_PATTERN_EN_QWERTY_NEAR_UPPER
     *
     * @return                  0 if success; minus value(error code) if fail.
     */
     ...
     * @see net.gorry.android.input.nicownng.WnnDictionary#SEARCH_EXACT
     * @see net.gorry.android.input.nicownng.WnnDictionary#SEARCH_PREFIX
     * @param order         The sort order
     * @see net.gorry.android.input.nicownng.WnnDictionary#ORDER_BY_FREQUENCY
     * @see net.gorry.android.input.nicownng.WnnDictionary#ORDER_BY_KEY
     ...
     *
     * @see net.gorry.android.input.nicownng.WnnDictionary#POS_TYPE_V1
     * @see net.gorry.android.input.nicownng.WnnDictionary#POS_TYPE_V2
     * @see net.gorry.android.input.nicownng.WnnDictionary#POS_TYPE_V3
     * @see net.gorry.android.input.nicownng.WnnDictionary#POS_TYPE_BUNTOU
     * @see net.gorry.android.input.nicownng.WnnDictionary#POS_TYPE_TANKANJI
     * @see net.gorry.android.input.nicownng.WnnDictionary#POS_TYPE_SUUJI
     * @see net.gorry.android.input.nicownng.WnnDictionary#POS_TYPE_MEISI
     * @see net.gorry.android.input.nicownng.WnnDictionary#POS_TYPE_JINMEI
     * @see net.gorry.android.input.nicownng.WnnDictionary#POS_TYPE_CHIMEI
     * @see net.gorry.android.input.nicownng.WnnDictionary#POS_TYPE_KIGOU
    */
