...
public class SetupKeyboardBell extends SetupKeyboard {
	...
	public HashMap<String, String> SetupReplaceTable(final boolean du) {
		return (du ? JP_FULL_BELL_REPLACE_TABLE_2 : JP_FULL_BELL_REPLACE_TABLE_1);
	}
	/*********************************
	 *
	 */
	...
	public int SetupModeKeyString() {
		return R.string.key_12key_mode_bell;
	}
	/*********************************
	 *
	 */
	...
	private static final HashMap<String, String> JP_FULL_BELL_REPLACE_TABLE_1 = new HashMap<String, String>() {
		/**
		 *
		 */
	...
	private static final HashMap<String, String> JP_FULL_BELL_REPLACE_TABLE_2 = new HashMap<String, String>() {
		/**
		 *
		 */
		private static final long serialVersionUID = 1L;
	...
	private static final int selectLandKeyTable[] = {
		R.xml.key_bell_top_0,
		R.xml.key_bell_shift_0,
		R.xml.key_bell_a_0,
		R.xml.key_bell_k_0,
		R.xml.key_bell_s_0,
		R.xml.key_bell_t_0,
		...
		R.xml.key_bell_r_0,
		R.xml.key_bell_w_0,
		R.xml.key_bell_input_top_0,
		R.xml.key_bell_input_shift_0,
		R.xml.key_bell_input_a_0,
		R.xml.key_bell_input_k_0,
		R.xml.key_bell_input_s_0,
		R.xml.key_bell_input_t_0,
		R.xml.key_bell_input_n_0,
		R.xml.key_bell_input_h_0,
		R.xml.key_bell_input_m_0,
		R.xml.key_bell_input_y_0,
		R.xml.key_bell_input_r_0,
		R.xml.key_bell_input_w_0,

		R.xml.key_bell_katakana_full_top_0,
		R.xml.keyboard_12key_full_katakana_shift_0,
		R.xml.key_bell_katakana_full_a_0,
		R.xml.key_bell_katakana_full_k_0,
		R.xml.key_bell_katakana_full_s_0,
		R.xml.key_bell_katakana_full_t_0,
		R.xml.key_bell_katakana_full_n_0,
		R.xml.key_bell_katakana_full_h_0,
		R.xml.key_bell_katakana_full_m_0,
		R.xml.key_bell_katakana_full_y_0,
		R.xml.key_bell_katakana_full_r_0,
		R.xml.key_bell_katakana_full_w_0,
		R.xml.key_bell_katakana_full_input_top_0,
		R.xml.keyboard_12key_full_katakana_input_shift_0,
		R.xml.key_bell_katakana_full_input_a_0,
		R.xml.key_bell_katakana_full_input_k_0,
		R.xml.key_bell_katakana_full_input_s_0,
		R.xml.key_bell_katakana_full_input_t_0,
		R.xml.key_bell_katakana_full_input_n_0,
		R.xml.key_bell_katakana_full_input_h_0,
		R.xml.key_bell_katakana_full_input_m_0,
		R.xml.key_bell_katakana_full_input_y_0,
		R.xml.key_bell_katakana_full_input_r_0,
		R.xml.key_bell_katakana_full_input_w_0,

		R.xml.key_bell_katakana_half_top_0,
		R.xml.keyboard_12key_half_katakana_shift_0,
		R.xml.key_bell_katakana_half_a_0,
		R.xml.key_bell_katakana_half_k_0,
		R.xml.key_bell_katakana_half_s_0,
		R.xml.key_bell_katakana_half_t_0,
		R.xml.key_bell_katakana_half_n_0,
		R.xml.key_bell_katakana_half_h_0,
		R.xml.key_bell_katakana_half_m_0,
		R.xml.key_bell_katakana_half_y_0,
		R.xml.key_bell_katakana_half_r_0,
		R.xml.key_bell_katakana_half_w_0,
		R.xml.key_bell_katakana_half_input_top_0,
		R.xml.keyboard_12key_half_katakana_input_shift_0,
		R.xml.key_bell_katakana_half_input_a_0,
		R.xml.key_bell_katakana_half_input_k_0,
		R.xml.key_bell_katakana_half_input_s_0,
		R.xml.key_bell_katakana_half_input_t_0,
		R.xml.key_bell_katakana_half_input_n_0,
		R.xml.key_bell_katakana_half_input_h_0,
		R.xml.key_bell_katakana_half_input_m_0,
		R.xml.key_bell_katakana_half_input_y_0,
		R.xml.key_bell_katakana_half_input_r_0,
		R.xml.key_bell_katakana_half_input_w_0,
	};
	...
	private static final int selectFlickLandKeyTable[] = {
		...
		R.xml.key_bell_r_0,
		R.xml.key_bell_w_0,
		R.xml.key_bell_flick_input_top_0,
		R.xml.key_bell_input_shift_0,
		R.xml.key_bell_input_a_0,
		R.xml.key_bell_input_k_0,
		R.xml.key_bell_input_s_0,
		...
		R.xml.key_bell_flick_katakana_full_top_0,
		R.xml.keyboard_12key_full_katakana_shift_0,
		R.xml.key_bell_katakana_full_a_0,
		R.xml.key_bell_katakana_full_k_0,
		R.xml.key_bell_katakana_full_s_0,
		...
		R.xml.key_bell_katakana_full_r_0,
		R.xml.key_bell_katakana_full_w_0,
		R.xml.key_bell_flick_katakana_full_input_top_0,
		R.xml.keyboard_12key_full_katakana_input_shift_0,
		R.xml.key_bell_katakana_full_input_a_0,
		R.xml.key_bell_katakana_full_input_k_0,
		R.xml.key_bell_katakana_full_input_s_0,
		...
		R.xml.key_bell_flick_katakana_half_top_0,
		R.xml.keyboard_12key_half_katakana_shift_0,
		R.xml.key_bell_katakana_half_a_0,
		R.xml.key_bell_katakana_half_k_0,
		R.xml.key_bell_katakana_half_s_0,
		...
		R.xml.key_bell_katakana_half_r_0,
		R.xml.key_bell_katakana_half_w_0,
		R.xml.key_bell_flick_katakana_half_input_top_0,
		R.xml.keyboard_12key_half_katakana_input_shift_0,
		R.xml.key_bell_katakana_half_input_a_0,
		R.xml.key_bell_katakana_half_input_k_0,
		R.xml.key_bell_katakana_half_input_s_0,
